...
echo"
      <div class = 'row div_space '> 
		...
		$empID="SELECT employee.employeeID FROM employee, ahours WHERE employee.employeeID=ahours.employeeID and StartTime!='NULL' and EndTime!='NULL' and DayID='".$curday."'";
