...
<?php	echo"<form action='employeeinfo.php' method='POST'><input type='hidden' name='transfer' value=".$ID."></input><button type='submit'class='btn btn-primary'>Go Back</button> </form>";?>
