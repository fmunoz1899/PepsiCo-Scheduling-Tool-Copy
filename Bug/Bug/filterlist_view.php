        ...
        echo "<div class = 'col-md-10'>";
          ...
          echo "<tr>
			...
			while($row = $result->fetch_assoc()) {
				...
				<td><form method='POST' action='filterlist_view.php'>
					<input name='id' type='hidden' value=".$row['ItemID'].">
					...
					{
					  echo"<td>" .$row["ActualEndTime"]."</td>";
		  
					}
					else
					{
					  echo"	<td >" . date('g:ia',strtotime($row["ActualEndTime"]))."</td>";
					}
					echo"
