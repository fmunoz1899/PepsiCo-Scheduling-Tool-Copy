...
$searchl="%".$searchl."%";
	...
	echo"   <div class='row tbl_space'> 
			...
			while($row = $result->fetch_assoc()) 
			{
					...
					echo "<tr>
					<td  style = 'width: 80px'><button class='btn btn-success ELocAdmnFltr' type='button' data-toggle='modal' data-target='#EditLocAdmFltr' value='" . $row['LocationID'] . "'>Edit</button></td>
					<td  style = 'width: 80px'><form method='POST' class = 'hiddenform' action='adminfilterloc.php'><input name='id' type='hidden' value=".$row['LocationID'].">
