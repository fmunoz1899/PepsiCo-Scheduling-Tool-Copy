...
<head>
 ...
 <?php 
	...
	if(isset($_POST['orderID']))
	{
		...
		else if((($_POST['datepicker5']==date("m/j/Y") && $startTime<$curtime)) && ($curtime<='06:00:00' && $curtime>='22:00:00'))
        ...
        echo "<div class = 'col-md-10'>";
          ...
          echo "<tr>
			...
			while($row = $result->fetch_assoc()) 
			{
				$info = $row['ItemID'];
				echo "<tr>
				<td><button class='btn btn-success EditWO' type='button' data-toggle='modal' data-target='#EdWO' value='" . $row['ItemID'] . "'>Edit</button></td>
