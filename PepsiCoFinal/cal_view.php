...
?>
              ...
              <div class="form-group">
				...
				<textarea rows = "10" cols = "25" name="des" id = "des" readonly='true'></textarea>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
				...
				<input name='CalWOID' type='hidden' id = "CalWOID" value=""><button class = 'btn btn-danger'>Cancel</button></form>
			</div>
