          ...
          <div class="modal-content">
            ...
            <div class="modal-body modalContent">
			  ...
			  <label> State:</label> <br>
                	<select name="state" id="stateEdit" required>  <!--insert JS to make sure that --Select One-- is not submitted-->
				  <option value="" selected>--Select One--</option>
				  <option value="AL">Alabama</option>
				  <option value="AK">Alaska</option>
				  <option value="AZ">Arizona</option>
    ...
    echo "<div class='col-md-1'> </div>";
        echo "<div class = 'col-md-10'>";
          ...
          while($row = $result->fetch_assoc()) 
          {
            ...
            echo "<tr>
			  <td><button class='btn btn-success ELocMgr' type='button' data-toggle='modal' data-target='#EditLocMgr' value='" . $row['LocationID'] . "'>Edit</button></td>
			  <td><form method='POST' action='locations.php'><input name='id' type='hidden' value=".$row['LocationID']."><button class = 'btn btn-danger'>Remove</button></form></td>
