...
<head>
    ...
    <body>
        ...
        <div class="jumbotron text-center jumbotron2">
            <h1 class="font-weight-bold text-center">Admin Locations View</h1>
...
<?php
	...
	echo" 
				<div class='row div_space'> 
					...
					<div class='col-md-7'> 
						<form method='POST' action='adminfilterloc.php' class = 'form2'>
	...
	{
		header("location:login.php?loc_no_admin_tok");
		exit;
	}
...
<?php
	...
	if(isset($_POST['LocationName']) && isset($_POST['Address']) && isset($_POST['state']) && isset($_POST['ZipCode']) && isset($_POST['city']) && $_POST['state']!='')
	{
		...
		else if($cleanloc==$_POST['LocationName'] && $cleanadd==$_POST['Address'] && $cleanstate==$_POST['state'] && $cleanzip==$_POST['ZipCode'] && $cleancity==$_POST['city'])
		{
...
?>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="adminloc.php" method="POST">
                <p>Location Name: 
      ...
      <!------------------------------------->
	   <!-- Update Loc Modal -->
	   <div class="modal fade" id="EditLocAdm" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Edit Existing Location</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span> </button>
            </div>
            <div class="modal-body modalContent">
              <form class = "form1" action = "adminloc.php" method = "POST" >
			  ...
			  <label> State:</label> <br>
                	<select name="state" id="stateAEdit" required>  <!--insert JS to make sure that --Select One-- is not submitted-->
				  <option value="" selected>--Select One--</option>
				  <option value="AL">Alabama</option>
				  <option value="AK">Alaska</option>
				  <option value="AZ">Arizona</option>
...
<?php
	include('connect.php');
	$sqlL="SELECT LocationID, LocationName, StreetAdress, State,  City, Zip FROM location";
    ...
    echo "<div class='col-md-1'> </div>";
        echo "<div class = 'col-md-10'>";
          ...
          while($row = $result->fetch_assoc()) 
          {
            ...
            echo "<tr>
			  <td><button class='btn btn-success ELocAdmn' type='button' data-toggle='modal' data-target='#EditLocAdm' value='" . $row['LocationID'] . "'>Edit</button></td>
			  <td><form method='POST' action='adminloc.php'><input name='id' type='hidden' value=".$row['LocationID']."><button class = 'btn btn-danger'>Remove</button></form></td>
